...
function myFunction() {
  ...
  //trying to use .id to give tasktext a unique id somehow, preferably i would use a uuid

  taskText.id = `div_${task.replace(" ", "_")}`;
